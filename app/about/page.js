      ...
      <section className="bg-white py-14 md:py-16">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-slate-600">
              Give us your cleaning service and we will build you a website for free, then keep looking after your IT ongoing, through our partner <a href="https://ujyaaloit.com" target="_blank" rel="noopener noreferrer" className="font-bold text-brand-700 hover:underline">UjyaaloIT.com</a>. Sign your hotel, Airbnb or flats up for our continuous cleaning service to get started.
            </p>
          </div>
